...
//  8: saline         → 25  : 4.5. Other (Bare earth, rocky areas -#db4d4f,
...
var toList   = [369, 19, 25, 24, 23, 0, 13, 25, 12, 66, 0, 0];

var paletteRemap = [
  '#800080', '#C27BA0', '#db4d4f', "#d4271e", "#ffa07a",
  "#3D3D3D", "#ffffff", '#db4d4f', "#d6bc74", "#a89358",
  "#3D3D3D", '#3D3D3D'
];
...
var legendDict = {
  ...
  '3.2 + 3.3 Agro-forestry / Forest Plantation (369)': '#800080',
